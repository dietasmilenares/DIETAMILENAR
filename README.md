...
git clone https://github.com/dietasmilenares/DIETAMILENAR /home/ubuntu/Dieta-Milenar && \
chmod +x /home/ubuntu/Dieta-Milenar/init.sh && \
sudo bash /home/ubuntu/Dieta-Milenar/init.sh
```
